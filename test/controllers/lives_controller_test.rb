...
class LivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create life" do
    assert_difference('Life.count') do
      post lives_url, params: { life: { text: @life.text, title: @life.title } }
    end

    assert_redirected_to life_url(Life.last)
  end
  ...
  test "should update life" do
    patch life_url(@life), params: { life: { text: @life.text, title: @life.title } }
